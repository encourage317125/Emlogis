...
/**
 * Only assign an employee to a shift when the employee has the required skill
 * 
 * @author emlogis
 *
 */
public class EmployeeHasSkillFilter extends EmployeeFilters implements SelectionFilter<ChangeMove> {
	...
	public boolean accept(ScoreDirector scoreDirector, ChangeMove selection) {
		...
		return employeeHasSkill(shiftAssignment, employee);
	}
