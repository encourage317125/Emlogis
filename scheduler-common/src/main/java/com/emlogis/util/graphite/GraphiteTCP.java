package com.emlogis.util.graphite;
 ...
 */
public class GraphiteTCP implements GraphiteSender {
     ...
     */
    public GraphiteTCP(String hostname, int port) {
     ...
     */
    public GraphiteTCP(String hostname, int port, SocketFactory socketFactory) {
     ...
     */
    public GraphiteTCP(String hostname, int port, SocketFactory socketFactory, Charset charset) {
     ...
     */
    public GraphiteTCP(InetSocketAddress address) {
     ...
     * @param socketFactory the socket factory
     */
    public GraphiteTCP(InetSocketAddress address, SocketFactory socketFactory) {
     ...
     * @param charset       the character set used by the server
     */
    public GraphiteTCP(InetSocketAddress address, SocketFactory socketFactory, Charset charset) {
        this.hostname = null;
        this.port = -1;
    ...
    public void send(String name, String value, long timestamp) throws IOException {
        try {
            ...
            writer.write('\n');
            // TODO move that code so that we don't flush with each and every paquet.
            writer.flush();					
            this.failures = 0;
        } catch (Exception e) {
            failures++;
