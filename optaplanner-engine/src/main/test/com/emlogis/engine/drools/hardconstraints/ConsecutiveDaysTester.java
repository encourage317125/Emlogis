...
public class ConsecutiveDaysTester extends ConstraintTesterBase {
    ...
    public void testConsecDaysBrokenChain(){
        MinMaxContractLine contractLine = createMaxContractLine(ContractLineType.CONSECUTIVE_WORKING_DAYS, true, 3, -1);
        ...
        int numOfConsecDaysConstraints = getNumOfConstraintMatches(RuleName.MAX_CONSECUTIVE_DAYS_CONSTRAINT, scoreHolder.getConstraintMatchTotals());
    ...
    public void testRuleWeightMultiplier(){
        ...
        rosterInfo.putRuleWeightMultiplier(RuleName.MAX_CONSECUTIVE_DAYS_CONSTRAINT, ruleMultiplier);
    ...
    public void testConsecDaysInScheduleWindowViolated(){
        MinMaxContractLine contractLine = createMaxContractLine(ContractLineType.CONSECUTIVE_WORKING_DAYS, true, 3, -2);
        kSession.insert(contractLine);
