...
public class MinHoursWeekTester extends ConstraintTesterBase{
	...
	public void testMinHoursPerWeekEnoughHoursOneShiftOutsidePlanningWindow() {
		...
		MinMaxContractLine contractLine = createMinContractLineInHours(ContractLineType.HOURS_PER_WEEK, true, 11, -1);
		...
		int numOfMinPerWeekConstraints = getNumOfConstraintMatches(RuleName.MIN_HOURS_PER_WEEK_CONSTRAINT, scoreHolder.getConstraintMatchTotals());
	...
	@Test
	public void testTeamMinHoursPerWeekNotEnoughHoursTeam() {
	...
	public void testRuleWeightMultiplier() {
		...
		FactHandle rosterHandle = kSession.getFactHandle(rosterInfo);
		rosterInfo.putRuleWeightMultiplier(RuleName.MIN_HOURS_PER_WEEK_CONSTRAINT, ruleMultiplier);
		kSession.update(rosterHandle, rosterInfo);
	...
	public void testMinHoursPerWeekShiftsTooFarCase() {
		...
		int numOfHoursMissing = 13; //Each week is 13 hours short of the goal of 25h per week
		int numOfMinPerWeekConstraints = getNumOfConstraintMatches(RuleName.MIN_HOURS_PER_WEEK_CONSTRAINT, scoreHolder.getConstraintMatchTotals());
	...
	public void testMinHoursPerWeekEnoughHoursMultiShift() {
		MinMaxContractLine contractLine = createMinContractLineInHours(ContractLineType.HOURS_PER_WEEK, true, 29, -1);
	...
	@Test
	public void testMinHoursPerWeekNotEnoughTeamContract() {
		MinMaxContractLine contractLine = createMinContractLineInHours(ContractLineType.HOURS_PER_WEEK, true, 29, -1);
		...
		TeamAssociation teamAssosTwo = createTeamAssociation(employeeTwo, teamId);
		kSession.insert(teamAssosTwo);
		...
		ShiftAssignment thirdShiftAssignment = createShiftAssignment(employeeTwo, 0, thirdShift);
		...
		int empOneHoursShort = 5;
		int empTwoHoursShort = 18;
		BendableScoreHolder scoreHolder = (BendableScoreHolder) kSession.getGlobal(DroolsScoreDirector.GLOBAL_SCORE_HOLDER_KEY);
		int numOfMinPerWeekConstraints = getNumOfConstraintMatches(RuleName.MIN_HOURS_PER_WEEK_CONSTRAINT, scoreHolder.getConstraintMatchTotals());
		assertEquals(contractLine.getMinimumWeight() * (empOneHoursShort + empTwoHoursShort), numOfMinPerWeekConstraints);
	}
	...
	public void testMinHoursPerWeekNotEnoughHoursPTOWrongWeek() {
		...
		MinMaxContractLine contractLine = createMinContractLineInHours(ContractLineType.HOURS_PER_WEEK, true, 29,
				-1);
		...
		int numOfMinPerWeekConstraints = getNumOfConstraintMatches(RuleName.MIN_HOURS_PER_WEEK_CONSTRAINT,
				scoreHolder.getConstraintMatchTotals());
		assertEquals(-hoursShortFirstWeek, numOfMinPerWeekConstraints);
	}
	...
	public void testMinHoursPerWeekEnoughHoursPTO() {
		...
		//TODO:Make sure the CD time off is within the week you are looking for, FOR ALL THE RULES!!
	...
	public void testMinHoursPerWeekNotEnoughHoursExcludePTO() {
		...
		MinMaxContractLine contractLine = createMinContractLineInHours(ContractLineType.HOURS_PER_WEEK, true, minHours, -1);
	...
	@Test
	public void testMinHoursPerWeekNotEnoughHoursPTOOutside() {
		MinMaxContractLine contractLine = createMinContractLineInHours(ContractLineType.HOURS_PER_WEEK, true, 29, -1);
		...
		BendableScoreHolder scoreHolder = (BendableScoreHolder) kSession.getGlobal(DroolsScoreDirector.GLOBAL_SCORE_HOLDER_KEY);
		int numOfMinPerWeekConstraints = getNumOfConstraintMatches(RuleName.MIN_HOURS_PER_WEEK_CONSTRAINT, scoreHolder.getConstraintMatchTotals());
		assertEquals(contractLine.getMinimumWeight() * hoursShort, numOfMinPerWeekConstraints);
	}
