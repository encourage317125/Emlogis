...
public class OpenShiftsPreferences extends ConstraintTesterBase {
    ...
    @Test
    public void testAllOpenShiftsSeperated(){
        ...
        int numOfConsecDaysConstraints = getNumOfConstraintMatches(RuleName.OPEN_SHIFT_SEPARATION_RULE, scoreHolder.getConstraintMatchTotals());
        assertEquals(0, numOfConsecDaysConstraints);
    }
    
    @Test
    public void testTwoConsecutiveOpenShift(){
    ...
    @Test
    public void testTwoOverlappingOpenShift(){
        MinMaxContractLine contractLine = createMaxContractLine(ContractLineType.CONSECUTIVE_WORKING_DAYS, true, 1, -1);
        kSession.insert(contractLine);
    ...
    @Test
    public void testTwoOverlappingOneConsecutiveOpenShift(){
        MinMaxContractLine contractLine = createMaxContractLine(ContractLineType.CONSECUTIVE_WORKING_DAYS, true, 1, -1);
        kSession.insert(contractLine);
