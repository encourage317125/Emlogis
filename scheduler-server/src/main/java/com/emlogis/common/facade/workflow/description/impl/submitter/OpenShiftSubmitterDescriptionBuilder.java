...
@Local
@Default
@RequestDescriptionBuilderQualifier(value = "OPEN_SHIFT_REQUEST_ORIGINATOR_DESCRIPTION")
@TransactionManagement(value = TransactionManagementType.CONTAINER)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class OpenShiftSubmitterDescriptionBuilder implements DescriptionBuilder {
