...
@Local
@Default
@RequestDescriptionBuilderQualifier(value = "WIP_REQUEST_ORIGINATOR_DESCRIPTION")
@TransactionManagement(value = TransactionManagementType.CONTAINER)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class WorkInPlaceSubmitterDescriptionBuilder implements DescriptionBuilder {
