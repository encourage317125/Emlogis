...
@Local
@Default
@RequestDescriptionBuilderQualifier(value = "SHIFT_SWAP_REQUEST_MANAGER_DESCRIPTION")
@TransactionManagement(value = TransactionManagementType.CONTAINER)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class ShiftSwapManagerDescriptionBuilder implements DescriptionBuilder {
    ...
    public String build(WorkflowRequest request, DateTimeZone dtz, Locale locale) {
        ...
        if (request.getRequestStatus().equals(WorkflowRequestStatusDict.ADMIN_PENDING)) {
