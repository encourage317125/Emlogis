package com.emlogis.common.facade.workflow.description.impl.peer;
...
@Local
@Default
@RequestDescriptionBuilderQualifier(value = "SHIFT_SWAP_REQUEST_PEER_DESCRIPTION")
@TransactionManagement(value = TransactionManagementType.CONTAINER)
@TransactionAttribute(TransactionAttributeType.REQUIRED)
public class ShiftSwapPeerDescriptionBuilder implements DescriptionBuilder {
