...
import com.emlogis.common.security.ShaUtils;



public class ShaPasswordEncoder extends BaseHash {
	   ...
	   private ShaPasswordEncoder(ShaPasswordEncoder md) {
	      this();
	   ...
	   public Object clone() {
	      return new ShaPasswordEncoder(this);
	   }
	   ...
	   public String getEncryptedString(String strToEncrypt) {
		   byte bytesToEncrypt[] = strToEncrypt.getBytes();
	         ...
	         md.update(bytesToEncrypt[i]);
	         String result = ShaUtils.toString(md.digest());
